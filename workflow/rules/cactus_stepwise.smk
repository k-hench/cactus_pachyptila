...
snakemake --dag -R  cactus_stepwise | dot -Tsvg > dag_geno_stepwise.svg
...
rule single_job:
    ...
    shell:
      ...
      # needed to toggle cactus-restart mode without also restarting snakemake
      source sh/sm_side_effects.sh
      ...
      apptainer exec --cleanenv \
        ...
        {params.sif} \
        bash {input.job_script} $RESTART &>> {log}
